                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <form method="POST" action="{{ route('contact_us.store') }}">
                        ...
                        <div class="form-group">
                            <label for="name">Your Name</label><span class="required-indicator">*</span>
                            <input type="text" name="name" id="name" class="form-control" placeholder="Type name..." required>
                            <span class="text-danger">@error('name'){{ $message }}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="email">Your Email Address</label><span class="required-indicator">*</span>
                            <input type="email" name="email" id="email" class="form-control" placeholder="email@gmail.com" required>
                            <span class="text-danger">@error('email'){{ $message }}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="message">Your Message Here</label><span class="required-indicator">*</span>
                            <textarea name="message" id="message" class="form-control" placeholder="Lorem ipsum dolor sit amet..." required></textarea>
